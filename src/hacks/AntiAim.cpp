...
static settings::Int yaw_sideways_max{ "antiaim.yaw.sideways.max", "0" };
...
case 10: // Omega
    ...
    case 2: // Jitter
        ...
        break;
    case 3: // Random
        p = RandFloatRange(-179.0f, 179.0f);
        break;
    case 4: // Flip
        if (tickcount % 3)
            p = 180.0f;
    ...
    case 7: // Fake down
        p = 271.0f;
        break;
    case 8: // Fake center (down)
        p = 360.0f;
        break;
    case 9: // Fake center (up)
        p = -360.0f;
        break;
    case 10: // Up
        p = -89.0f;
